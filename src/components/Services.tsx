    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          {/* Service 1 */}
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-12 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
                src={service1}
                alt="service1"
                className="w-full h-full object-cover md:object-right opacity-70 md:opacity-100"
                width={800}
                height={730}
              />
            </div>
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlocks the potential of <br className="md:hidden" />
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            {/* Service 3 */}
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden min-h-[16rem]">
